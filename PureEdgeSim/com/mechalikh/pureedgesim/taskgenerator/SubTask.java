...
public class SubTask extends TaskAbstract {
	...
	private List<SubTask> dependentTasks = new ArrayList<SubTask>();
	...
	@Override
	public SubTask setFileSizeInBits(long requestSize) {
		this.fileSize = requestSize;
		return this;
	}

	@Override
	public SubTask setOutputSizeInBits(long outputSize) {
	...
	public void addDestination(SubTask subTask) {
		this.dependentTasks.add(subTask);
	}

	public List<SubTask> getDependentTasks() {
		return this.dependentTasks;
	}

	public void hasBeenReturned(boolean hasBeenReturned) {
